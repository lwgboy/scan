...
public class SettingActivity extends Activity implements OnClickListener {
    ...
    private String[] powers = {"26dbm", "24dbm", "20dbm", "18.5dbm", "17dbm",
            "15.5dbm", "14dbm", "12.5dbm"};
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.button_min:
                ...
                Toast.makeText(getApplicationContext(), R.string.setSuccess, 0)
                        .show();
                break;
            ...
            case R.id.button4:
                ...
                if (freqStr == null || "".equals(freqStr)) {
                    Toast.makeText(getApplicationContext(), R.string.freqSetting, 0)
                            .show();
                    return;
                }
